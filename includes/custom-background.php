...
add_action( 'after_setup_theme', 'mina_olen_custom_background_setup', 15 );
 ...
 * @return void
 */
function mina_olen_custom_background_setup() {
	...
	add_theme_support(
		...
		array(
			...
			'default-image'    => '',
			'wp-head-callback' => 'mina_olen_custom_background_callback',
		)
	);
}
 ...
 * @return void
 */
function mina_olen_custom_background_callback() {
