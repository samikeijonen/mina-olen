<article <?php hybrid_attr( 'post' ); ?>>
	...
	<?php get_the_image( array( 'before' => '<div class="entry-media">', 'after' => '</div>', 'size' => 'large', 'split_content' => true, 'scan_raw' => true, 'scan' => true, 'order' => array( 'scan_raw', 'scan', 'featured', 'attachment' ) ) ); ?>
